...
public class MpmcGenerationPQStress {
    @JCStressTest
    ...
    public static class NoLostWrites {
        private MpmcGenerationPQ<Integer> pq;
        private Set<Integer> seen;
        private Queue<Integer> queue;


        public NoLostWrites() {
            this.pq = new MpmcGenerationPQ<>(8);
    ...
    public static class generationPriorityInvariant {
        ...
        public generationPriorityInvariant() {
            this.pq = new MpmcGenerationPQ<>(8); //should see 3 before 1 (2 - 3 - 1)
    ...
    public static class AddRemoveLinearizability {
        ...
        public AddRemoveLinearizability() {
            this.pq = new MpmcGenerationPQ<>(4); //should see 3 before 1 (2 - 3 - 1)
        }
